...
This script is provided only as a convenience. For a service this should be
used to generate tokens that can make requests on behalf of the app.
...
if __name__ == "__main__":
    ...
    def do_auth_flow(api_root, cid, secret, scopes, redirect):
        print "Visit %s in a browser" % get_auth_url(api_root, cid,
                                                     scopes, redirect)
